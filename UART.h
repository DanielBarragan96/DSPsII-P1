/**
	...
	\author Chung Correa Sergio Raúl
	\date	27/07/2015
 */
#ifndef UART_H_
#define UART_H_
 ...
 */
typedef struct{
	BooleanType flag; /** Flag to indicate that there is new data*/
	BooleanType flagEnter;
...
/*!
 	 ...
 	 \return void
 */
void UART_Status_IRQHandler(void);
...
/********************************************************************************************/
/*!
 	 \brief	 Sets the ENTER pressed flag TRUE
 	 \return void
 */
void setflagE();
...
/********************************************************************************************/
/*!
 	 \brief	Sets the ENTER pressed flag FLASE
 	 \return void
 */
void clearflagE();
...
/********************************************************************************************/
/*!
 	 \brief	 This function return the current state of ENTER flag
 	 \return BooleanType
 */
...
/********************************************************************************************/
/*!
 	 \brief	 Sets the mailbos flag TRUE. This when any key is pressed
 	 \return void
 */
void setFlagM();
...
/********************************************************************************************/
/*!
 	 \brief	 Sets the mailbox flag FALSE
 	 \return void
 */
void clearFlagM();
...
/********************************************************************************************/
/*!
 	 \brief	 Returns the current state of the mailbox flag
 	 \return BooleanType
 */
